...
class VectorSearchService:
    ...
    def search_nodes(self, query_text: str, user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7) -> List[VectorSearchResult]:
        ...
        for search_func in [
            ...
            try:
                results = search_func(query_embedding, user_id, campaign_id, limit, threshold)
    ...
    def find_similar_to_node(self, node_id: str, user_id: str, campaign_id: Optional[str] = None, limit: int = 5, threshold: float = 0.7) -> List[VectorSearchResult]:
        ...
        for search_func in [
            ...
            try:
                results = search_func(target_embedding, user_id, campaign_id, limit, threshold, exclude_id=node_id)
                all_results.extend(results)
            except Exception as e:
    ...
    def _search_campaigns(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def _search_characters(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def _search_locations(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def _search_notes(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def _search_npcs(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def _search_sessions(self, embedding: List[float], user_id: str, campaign_id: Optional[str] = None, limit: int = 10, threshold: float = 0.7, exclude_id: Optional[str] = None) -> List[VectorSearchResult]:
    ...
    def suggest_relationships(self, user_id: str, campaign_id: Optional[str] = None, threshold: float = 0.8):

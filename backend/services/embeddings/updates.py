...
class EmbeddingUpdateService:
    ...
    def update_campaign_embeddings(self, campaign_id: str, force: bool = False) -> dict[str, Any]:
        ...
        if not nodes:
            return {"message": "No nodes found", "processed": 0, "updated": 0, "skipped": 0}

...
def detect_note_type(content: str, frontmatter_data: dict) -> str:
    ...
    if 'type' in frontmatter_data:
        ...
        valid_types = ['Note', 'Character', 'Location', 'Quest', 'Event', 'Session', 'NPC', 'Item', 'Lore', 'Rule']
    ...
    if any(keyword in content_lower for keyword in ['character', 'npc', 'personality', 'backstory']):
        return 'Character'
    elif any(keyword in content_lower for keyword in ['location', 'place', 'city', 'town', 'region']):
        return 'Location'
    elif any(keyword in content_lower for keyword in ['quest', 'mission', 'objective', 'goal']):
        return 'Quest'
    elif any(keyword in content_lower for keyword in ['event', 'happening', 'occurrence']):
        return 'Event'
    elif any(keyword in content_lower for keyword in ['session', 'game session', 'adventure']):
        return 'Session'
    elif any(keyword in content_lower for keyword in ['item', 'artifact', 'weapon', 'armor', 'equipment']):
        return 'Item'
    elif any(keyword in content_lower for keyword in ['lore', 'history', 'legend', 'mythology']):
        return 'Lore'
